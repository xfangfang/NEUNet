...
public class TableView extends View {
    ...
    private float getColumnWidth(int columnIndex) {
        ...
        int weight = this.columnWeights.length > columnIndex ? this.columnWeights[columnIndex] : 1;
    ...
    public void refreshTable() {
        ...
        unitColumnWidth = (getMeasuredWidth() - (columnCount + 1) * dividerWidth)/weightSum;
        invalidate();
        requestLayout();
    }
